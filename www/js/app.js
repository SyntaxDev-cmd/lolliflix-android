...
(function () {
  ...
  function openLiveCatDo(cat, main) {
    ...
    p.then(function (chs) {
      ...
      main.innerHTML = '<div class="chan-list">' + chs.map(function (c, i) {
      ...
      Array.prototype.forEach.call(main.querySelectorAll('[data-favch]'), function (n) {
        n.addEventListener('click', function (e) {
          ...
          var on = window.Store.toggleFavorite(chs[i]);
          n.classList.toggle('on', on); n.innerHTML = on ? IC.starFill : IC.star;
  ...
  function screenSettings() {
    ...
    h('<div class="view col"><div class="subhdr"><button class="back-btn" data-back>' + IC.back + '</button><h2>Ajustes</h2></div>' +
      ...
      '<div class="set-card"><div class="set-title">Perfis</div><div class="set-desc">Conta atual: <b>' + esc(state.server ? state.server.user : '-') + '</b></div>' +
      '<div class="row" style="gap:10px; flex-wrap:wrap"><button class="btn" id="addProfile" style="width:auto;padding:0 22px">Adicionar / trocar perfil</button>' +
